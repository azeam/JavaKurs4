...
public class Painter {
    ...
    static void paint(GraphicsContext gc) {
        gc.setFill(Color.BLACK);
        gc.fillRect(0, 0, Constants.ALL_ROOMS_WIDTH, Constants.ROOM_HEIGHT);
    }

    static void paintRoom(GraphicsContext gc, int order, String doorLocation) {
    ...
    static void paintPerson(GraphicsContext gc, int x, int y, String name) {
        gc.setFill(Color.WHITE);
